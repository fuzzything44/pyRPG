...
def generate():
    ...
    world.map[32][4] = [0, 'p', True]
    world.map[33][4] = [0, 'a', True]
    world.map[34][4] = [0, 'c', True]
    world.map[35][4] = [0, 'e', True]
    world.map[36][4] = [0, ' ', True]
    world.map[37][4] = [0, 'T', True]
    world.map[38][4] = [0, 'o', True]
    world.map[39][4] = [0, ' ', True]
    world.map[40][4] = [0, 'C', True]
    world.map[41][4] = [0, 'a', True]
