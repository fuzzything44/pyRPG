...
def generate():
    ...
    world.objects.append(world_object.world_object(portal.update, portal.collide, portal.char, portal.color, portal.type, 1,0,{"newmap": "credits", "locx": 0, "locy": 10, "used" : False}))
