...
def generate():
    ...
    world.objects = [world_object.world_object(portal.update, portal.collide, portal.char, portal.color, portal.type, 49,10,{"newmap": "end", "locx": 0, "locy": 10, "used" : False})]
    world.objects = [world_object.world_object(portal.update, portal.collide, portal.char, portal.color, portal.type, 45,19,{"newmap": "stonstart", "locx": 0, "locy": 10, "used" : False})]
