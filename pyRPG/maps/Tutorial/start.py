...
def generate():
    ...
    world.objects.append(world_object.world_object(portal.update, portal.collide, portal.char, portal.color, portal.type, 25,8,{"newmap": "tutorial.1", "locx": 0, "locy": 10, "used" : False}))
