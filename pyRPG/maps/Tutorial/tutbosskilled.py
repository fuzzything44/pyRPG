...
def generate():
    ...
    world.objects.append(obj_maker.make(portal, 49, 10, {"newmap": "town", "locx": 25, "locy": 10, "used" : False}))
    ...
    world.map[18][7] = [0, 1, 'n', True]
    world.map[19][7] = [0, 1, 'd', True]
    world.map[20][7] = [0, 1, ' ', True]
    world.map[21][7] = [0, 1, 'p', True]
    world.map[22][7] = [0, 1, 'r', True]
    world.map[23][7] = [0, 1, 'e', True]
    world.map[24][7] = [0, 1, 's', True]
    world.map[25][7] = [0, 1, 's', True]
    world.map[26][7] = [0, 1, 'i', True]
    world.map[27][7] = [0, 1, 'n', True]
    world.map[28][7] = [0, 1, 'g', True]
    world.map[29][7] = [0, 1, ' ', True]
    world.map[30][7] = [0, 1, '\'', True]
    world.map[31][7] = [0, 1, 'E', True]
    world.map[32][7] = [0, 1, '\'', True]
    ...
    world.map[11][15] = [0, 1, 'F', True]
    world.map[12][15] = [0, 1, 'i', True]
    world.map[13][15] = [0, 1, 'n', True]
    world.map[14][15] = [0, 1, 'a', True]
    world.map[15][15] = [0, 1, 'l', True]
    world.map[16][15] = [0, 1, 'l', True]
    world.map[17][15] = [0, 1, 'y', True]
    world.map[18][15] = [0, 1, ',', True]
    world.map[19][15] = [0, 1, ' ', True]
    world.map[20][15] = [0, 1, 'i', True]
    world.map[21][15] = [0, 1, 'n', True]
    world.map[22][15] = [0, 1, ' ', True]
    world.map[23][15] = [0, 1, 't', True]
    world.map[24][15] = [0, 1, 'h', True]
    world.map[25][15] = [0, 1, 'e', True]
    world.map[26][15] = [0, 1, ' ', True]
    world.map[27][15] = [0, 1, 'm', True]
    world.map[28][15] = [0, 1, 'e', True]
    world.map[29][15] = [0, 1, 'n', True]
    world.map[30][15] = [0, 1, 'u', True]
    world.map[31][15] = [0, 1, ',', True]
    world.map[32][15] = [0, 1, ' ', True]
    world.map[33][15] = [0, 1, 's', True]
    world.map[34][15] = [0, 1, 'e', True]
    world.map[35][15] = [0, 1, 't', True]
    world.map[36][15] = [0, 1, ' ', True]
    world.map[37][15] = [0, 1, 'i', True]
    world.map[38][15] = [0, 1, 't', True]
    ...
    world.map[11][16] = [0, 1, 'u', True]
    world.map[12][16] = [0, 1, 'n', True]
    world.map[13][16] = [0, 1, 'd', True]
    world.map[14][16] = [0, 1, 'e', True]
    world.map[15][16] = [0, 1, 'r', True]
    world.map[16][16] = [0, 1, ' ', True]
    world.map[17][16] = [0, 1, 't', True]
    world.map[18][16] = [0, 1, 'h', True]
    world.map[19][16] = [0, 1, 'e', True]
    world.map[20][16] = [0, 1, ' ', True]
    world.map[21][16] = [0, 1, '"', True]
    world.map[22][16] = [0, 1, 'I', True]
    world.map[23][16] = [0, 1, 'n', True]
    world.map[24][16] = [0, 1, 'v', True]
    world.map[25][16] = [0, 1, 'e', True]
    world.map[26][16] = [0, 1, 'n', True]
    world.map[27][16] = [0, 1, 't', True]
    world.map[28][16] = [0, 1, 'o', True]
    world.map[29][16] = [0, 1, 'r', True]
    world.map[30][16] = [0, 1, 'y', True]
    world.map[31][16] = [0, 1, '"', True]
    world.map[32][16] = [0, 1, ' ', True]
    world.map[33][16] = [0, 1, 'o', True]
    world.map[34][16] = [0, 1, 'p', True]
    world.map[35][16] = [0, 1, 't', True]
    world.map[36][16] = [0, 1, 'i', True]
    world.map[37][16] = [0, 1, 'o', True]
    world.map[38][16] = [0, 1, 'n', True]
    ...
    world.map[7][17] = [0, 1, 'P', True]
    world.map[8][17] = [0, 1, 'r', True]
    world.map[9][17] = [0, 1, 'e', True]
    world.map[10][17] = [0, 1, 's', True]
    world.map[11][17] = [0, 1, 's', True]
    world.map[12][17] = [0, 1, ' ', True]
    world.map[13][17] = [0, 1, 'L', True]
    world.map[14][17] = [0, 1, 'E', True]
    world.map[15][17] = [0, 1, 'F', True]
    world.map[16][17] = [0, 1, 'T', True]
    world.map[17][17] = [0, 1, ' ', True]
    world.map[18][17] = [0, 1, 'S', True]
    world.map[19][17] = [0, 1, 'H', True]
    world.map[20][17] = [0, 1, 'I', True]
    world.map[21][17] = [0, 1, 'F', True]
    world.map[22][17] = [0, 1, 'T', True]
    world.map[23][17] = [0, 1, ' ', True]
    world.map[24][17] = [0, 1, 't', True]
    world.map[25][17] = [0, 1, 'o', True]
    world.map[26][17] = [0, 1, ' ', True]
    world.map[27][17] = [0, 1, 'u', True]
    world.map[28][17] = [0, 1, 's', True]
    world.map[29][17] = [0, 1, 'e', True]
    world.map[30][17] = [0, 1, ' ', True]
    world.map[31][17] = [0, 1, 'y', True]
    world.map[32][17] = [0, 1, 'o', True]
    world.map[33][17] = [0, 1, 'u', True]
    world.map[34][17] = [0, 1, 'r', True]
    world.map[35][17] = [0, 1, ' ', True]
    world.map[36][17] = [0, 1, 'c', True]
    world.map[37][17] = [0, 1, 'u', True]
    world.map[38][17] = [0, 1, 'r', True]
    world.map[39][17] = [0, 1, 'r', True]
    world.map[40][17] = [0, 1, 'e', True]
    world.map[41][17] = [0, 1, 'n', True]
    world.map[42][17] = [0, 1, 't', True]
    world.map[46][17] =  [display.RED, display.RED, '#', True]
    world.map[47][17] =  [display.RED, display.RED, '#', True]
    world.map[5][18] = [0, 1, 'c', True]
    world.map[6][18] = [0, 1, 'o', True]
    world.map[7][18] = [0, 1, 'n', True]
    world.map[8][18] = [0, 1, 's', True]
    world.map[9][18] = [0, 1, 'u', True]
    world.map[10][18] = [0, 1, 'm', True]
    world.map[11][18] = [0, 1, 'a', True]
    world.map[12][18] = [0, 1, 'b', True]
    world.map[13][18] = [0, 1, 'l', True]
    world.map[14][18] = [0, 1, 'e', True]
    world.map[15][18] = [0, 1, '.', True]
    world.map[16][18] = [0, 1, ' ', True]
    world.map[17][18] = [0, 1, 'M', True]
    world.map[18][18] = [0, 1, 'a', True]
    world.map[19][18] = [0, 1, 'k', True]
    world.map[20][18] = [0, 1, 'e', True]
    world.map[21][18] = [0, 1, ' ', True]
    world.map[22][18] = [0, 1, 's', True]
    world.map[23][18] = [0, 1, 'u', True]
    world.map[24][18] = [0, 1, 'r', True]
    world.map[25][18] = [0, 1, 'e', True]
    world.map[26][18] = [0, 1, ' ', True]
    world.map[27][18] = [0, 1, 'y', True]
    world.map[28][18] = [0, 1, 'o', True]
    world.map[29][18] = [0, 1, 'u', True]
    world.map[30][18] = [0, 1, ' ', True]
    world.map[31][18] = [0, 1, 'd', True]
    world.map[32][18] = [0, 1, 'o', True]
    world.map[33][18] = [0, 1, 'n', True]
    world.map[34][18] = [0, 1, '\'', True]
    world.map[35][18] = [0, 1, 't', True]
    world.map[36][18] = [0, 1, ' ', True]
    world.map[37][18] = [0, 1, 'r', True]
    world.map[38][18] = [0, 1, 'u', True]
    world.map[39][18] = [0, 1, 'n', True]
    world.map[40][18] = [0, 1, ' ', True]
    world.map[41][18] = [0, 1, 'o', True]
    world.map[42][18] = [0, 1, 'u', True]
    world.map[43][18] = [0, 1, 't', True]
    world.map[44][18] = [0, 1, '!', True]
