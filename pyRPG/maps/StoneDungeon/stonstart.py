...
def generate():
    ...
    world.objects.append(world_object.world_object(lock_portal.update, lock_portal.collide, lock_portal.char, lock_portal.color, lock_portal.type, 49,10,{"newmap": "stone1", "locx": 2, "locy": 10, "used" : False}))
    world.map[49][10] = world.WORLD_NOTHING # Let them walk on portal.
    world.objects.append(world_object.world_object(portal.update, portal.collide, portal.char, portal.color, portal.type, 0,10,{"newmap": "town", "locx": world.WORLD_X - 2, "locy": 10, "used" : False}))
    ...
    world.objects.append(world_object.world_object(shoot_enemy.update, shoot_enemy.collide, shoot_enemy.char, shoot_enemy.color, shoot_enemy.type, 45, 10, copy.deepcopy(shoot_enemy.attributes)))
