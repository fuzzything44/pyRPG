...
def generate():
    ...
    world.objects.append(portal.portal(0, 10, "stonedungeon.start", world.WORLD_X - 1, 10))
    world.objects.append(lock_portal.lock_portal(world.WORLD_X - 1, 10, "stonedungeon.2", 2, 10))
