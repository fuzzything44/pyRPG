...
def generate():
    ...
    world.objects.append(world_object.world_object(portal.update, portal.collide, portal.char, portal.color, portal.type, 25,8,{"newmap": "test_world", "locx": 25, "locy": 10, "used" : False}))
