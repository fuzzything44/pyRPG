...
def generate():
    ...
    world.objects.append(war_tut.war_enemy.war_enemy(30, 7))
    world.objects.append(war_tut.war_enemy.war_enemy(20, 3))
    world.objects.append(war_tut.war_enemy.war_enemy(10, 5))
