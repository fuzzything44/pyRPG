...
class directed_attack(General.base_attack.base_attack):
    def __init__(this, posX, posY, damage, owner, move_x, move_y, speed, die_on_walls = True):
        super().__init__(posX, posY, damage, owner)
        this.attributes.update({"move_x" : move_x, "move_y" : move_y, "speed" : speed, "sincemove" : 0, "die_on_walls" : die_on_walls})
